...
CREATE TABLE IF NOT EXISTS `v2_user_subscribe_log` (
...
CREATE TABLE IF NOT EXISTS `v2_subscription_control_user_policies` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `v2_subscription_control_region_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `v2_subscription_control_ip_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `v2_subscription_control_ua_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `keywords` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `v2_subscription_control_hit_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int unsigned NOT NULL DEFAULT '0',
